...
// Slugify for auto-scroll back button
...
export default function GXM011() {
  ...
  const product = {
    ...
    basicCombo: [
      "High-Performance Pressure Motor",
      "Advanced Steel Precision Impeller",
      "Premium Noise Control System",
      "Thermal Overload Safety Protection",
      "Anti-Vibration Stabilized Base",
      "Continuous Water Flow Stability",
      "Premium Multi-Coated Housing"
    ],

    optionalFeatures: [
      "Digital Smart Control Panel",
      "Automatic Pressure Monitoring Unit",
      "Noise Reduction Silencer",
      "Eco Power Saver Module",
      "Extended Life Heavy-Duty Bearings"
    ],
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* SIZES */}
          <h2 style={{ color: "#d4af37", fontSize: "22px" }}>Size / Model</h2>
          <div
            style={{
              display: "grid",
