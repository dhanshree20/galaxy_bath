...
export default function GX5533() {
  ...
  const product = {
    ...
    material: "High-Durability Tempered Glass",
    color: "Crystal Clear / Chrome Trim",

    basicCombo: [
      "8mm Toughened Glass",
      "Premium Stainless Steel Hinges",
      "Anti-Corrosion Chrome Hardware",
      "Smooth Open/Close Mechanism",
      "Water-Sealed Edges",
      "Anti-Scratch Surface Coating",
      "Chrome Wall-Fixed Fittings"
    ],

    optionalFeatures: [
      "Black Matt Hardware",
      "Rose Gold Hinges",
      "Luxury Golden Hardware",
      "Frosted / Patterned Glass Option",
      "Custom Height & Width Available"
    ],

    faucetSets: [
      "Steam & Sauna Compatible",
      "Fits All Shower Panel Types",
      "Spa & Jacuzzi Partition Compatible"
    ]
  };
