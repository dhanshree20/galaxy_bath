...
export default function GXM003() {
  ...
  const product = {
    ...
    color: "Steel / Matte Black / Chrome",

    basicCombo: [
      "Rainfall Overhead Shower",
      "Waterfall Output",
      "Hand Shower Multiflow",
      "Body Jets × 4 High-Pressure",
      "Hot & Cold Mixer",
      "Thermostatic Control",
      "Anti-Clog Silicone Nozzles",
      "Premium Wall Mounted Panel"
    ],
