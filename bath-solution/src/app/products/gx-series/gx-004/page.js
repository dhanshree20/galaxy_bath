...
export default function GX004() {
  ...
  const product = {
    ...
    basicCombo: [
      ...
      "High-Pressure Vertical Body Jets",
      "Hand Shower with SS Flexible Hose",
      "Hot & Cold Mixer Control",
      "Heavy-duty Stainless Steel Panel",
      "Tempered Glass Front",
      "Water Flow Stabilizer",
      "Ergonomic Shower Control System"
    ],

    optionalFeatures: [
      "LED Soft Glow Backlight",
      "Digital Temperature Display",
      "Music Bluetooth System",
      "Anti-Fog Smart Mirror",
      "HydroPulse Massage Mode"
    ],

    faucetSets: [
      "Compatible with: Steam Cabins, Bath Tubs, Spa Units",
      "Operates on High-Pressure Systems"
    ]
  };
