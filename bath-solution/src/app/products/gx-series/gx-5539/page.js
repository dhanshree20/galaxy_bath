...
// ⭐ Slugify function (for back button navigation)
...
export default function GX5539() {
  ...
  const product = {
    ...
    material: "High-Durability Tempered Glass (8mm)",
    color: "Crystal Clear / Chrome Trim",

    basicCombo: [
      "8mm Toughened Glass",
      "Premium Stainless Steel Hinges",
      "Smooth Open/Close System",
      "Anti-Scratch Coating",
      "Water-Sealed Edges",
      "Anti-Corrosion Hardware",
      "Chrome Wall-Mounted Fittings"
    ],
    ...
    faucetSets: [
      ...
      "Compatible with Jacuzzi / Spa Partitions",
      "Supports All Shower Panel Types"
    ]
  };
