...
export default function GXM008() {
  ...
  const product = {
    ...
    material: "Industrial-Grade Stainless Steel + Heavy Reinforced Housing",
    color: "Black / Chrome Finish",

    basicCombo: [
      "High-Torque Industrial Motor",
      "Advanced Cooling & Heat Dissipation",
      "Reinforced Stainless Steel Impeller",
      "Shock-Proof Electrical Housing",
      "Automatic Overload Cut-Off",
      "Low-Vibration Balanced Base",
      "High-Volume Pressure Delivery",
    ],

    optionalFeatures: [
      "Smart Pressure Sensor (Digital)",
      "Auto On/Off Float System",
      "Energy Saver Booster Module",
      "Extended Pressure Expansion Kit",
    ],

    faucetSets: [
      "Compatible with entire GXM Series | Hydro System | Bath & Spa Units",
    ],
  };
        ...
        <div style={{ flex: "1", minWidth: "320px" }}>
          <div
            style={{
              ...
              overflow: "hidden",
              border: "2px solid #d4af37",
              boxShadow: "0 0 27px rgba(212,175,55,0.28)",
            }}
          >
            <img
              src={product.img}
