...
// Slugify → for back-button scroll target
...
export default function GXM006S() {
  ...
  const product = {
    ...
    material: "Industrial-Grade Stainless Steel + Reinforced Alloy Body",
    ...
    basicCombo: [
      ...
      "Quick-Access Service Body",
      "High-Efficiency Pump Head",
    ...
    optionalFeatures: [
      ...
      "Energy Saver Smart Module",
      "Extended Pressure Boost Kit",
    ],

    faucetSets: [
      "Fully Compatible with Galaxy GXM Pump Range & Hydro Units",
    ],
  };
