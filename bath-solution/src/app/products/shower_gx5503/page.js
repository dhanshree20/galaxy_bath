...
const page = () => {
      ...
      const product = {
        name: "GX 5503",
        img: "/shower/shower1.png",
        sizes: [
          "1300 x 210",
        ],
        color: "SS Brushed + White ",
        basicCombo: [
          "Thermostatic Mixer with LED Lights.",
          "Six Body Massage Jets ",
          "Single Liver Mixture (H/C)",
          " Over Head Shower",
          "Hand Shower, Waterfall",
          "Tub Filler Spout",
        ],
      };
  ...
  return (
    ...
    >
      {/* ⭐ BACK BUTTON */}
      <button
        onClick={() => router.push("/product?category=shower-panel")}
        style={{
