...
// Slugify for dynamic back button scroll
...
export default function GalaxyVeronaRoundSauna() {
  const router = useRouter();

  const product = {
    name: "Galaxy Verona Round (Sauna-capable)",
    img: "/all_products/sauna/Galaxy_Verona_Round.jpg",
    ...
    optionalFeatures: [
      ...
      "Air Blower 400w",
      "12 Bubble Jets",
      "Sauna-Compatible Heating Chamber",
      "High Temperature Resistant Acrylic",
