...
// Slugify for back-button anchor scroll
...
export default function GalaxyRoundSpaSauna() {
  ...
  const product = {
    ...
    optionalFeatures: [
      ...
      "Air Blower 400w",
      "12 Bubble Jets",
      "Sauna-Ready Steam Integration",
      "Temperature-Safe Body Acrylic",
      "Steam Overflow Protection System"
    ],
    ...
    faucetSets: [
      ...
      "Waterfall Spout",
      "Online Heater (3kw)",
      "Steam-Compatible Diverter System"
    ]
  };
