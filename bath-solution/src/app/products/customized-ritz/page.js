...
export default function GalaxySmartRoundSteam() {
  ...
  const product = {
    ...
    sizes: ["Tailor Made (As per Bathroom Size)"],
    ...
    steamFeatures: [
      ...
      "High Temperature Reinforced Acrylic Body",
      "Steam Nozzle Support",
      "Aroma Diffuser Compatible (optional)"
    ],
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* SIZES GRID */}
          <h2 style={{ color: "#d4af37", fontSize: "22px" }}>Sizes Available</h2>
