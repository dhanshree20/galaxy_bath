...
const page = () => {
  ...
  const product = {
    ...
    // 🔹 Multiple Images
    images: [
      "/pressure_pump/pressure1.jpeg",
      "/pressure_pump/pressure3.jpeg",
    ],

    basicCombo: [
      "1.5HP Multistage Centrifungal Pump with SS Impeller with 60/100 Ltr. Air Tank.",
      "Pressure Switch and Other Accssories",
      "Operating Pressure Range 3.5 to 5.2 bar with Water flow of 60 LPM,Suitable For 4-5 bathroom.",
    ],
  };
