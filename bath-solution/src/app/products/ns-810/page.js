...
const page = () => {
  ...
  const product = {
    ...
    // ✅ MULTIPLE IMAGES
    images: [
      "/all_products/ns-810.png",
      "/all_products/ns-810_1.png",
    ],
        ...
        >
          ...
          <div style={{ display: "grid", gap: "28px" }}>
            <SpecSection title="Seating">
              <SpecRow label="Seating Capacity" value="5 Persons" />
            ...
            <SpecSection title="Jet Configuration">
              <SpecRow label="Jets Total (pc)" value="40" />
              <SpecRow
                label="3.5 inch Massage Jets (pc)"
                value="10 (8 pcs D-Jet, 2 pcs Rotating Jet)"
              />
              <SpecRow label="2.0 inch Massage Jets (pc)" value="2" />
              <SpecRow label="1.0 inch Massage Jets (pc)" value="20" />
            ...
            <SpecSection title="Features">
              ...
              <SpecRow label="Air Regulator (pc)" value="3" />
              ...
              <SpecRow label="Cup Holder with LED (pc)" value="3" />
