...
export default function GalaxyHotSpa() {
  ...
  const product = {
    ...
    images: [
      "/all_products/galaxy-round-spa.png",
      "/dimention/galaxy-round-spa.png",
    ],
    ...
    basicCombo: [
      "Whirlpool Pump 2 HP with 12 Jets",
      "Microcomputer Control Panel with Hi-Fi Speaker & FM Radio",
      "Under Water LED Light 2 Pcs",
      "Hot & Cold Mixing Valve with Handhold Shower and Waterfall Spout",
      "Pop Up Waste",
      "Bathtub Pillow 4 Pcs",
      "S.S. Stand",
      "Air Pump with 12 Air Jets",
      "Online Heater",
      "LED TV",
      "Wood / Acrylic Panel",
    ],
